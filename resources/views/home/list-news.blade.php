...
@section('main-contents')
    ...
    <div class="container p-5  bg-white shadow-lg" style="margin-top: -150px">
        ...
        <div class="row" style="margin-top: -80px">
            @foreach ($news as $nws)
                <div class="col-md-6 col-sm-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s" style="margin-bottom: -30px">
                    <div class="service-item shadow-lg">
                        ...
                        <div class="service-detail">
                            <div class="service-title">
                                @if ($nws->image == null)
                                    <div
                                        style="background-image: url({{ asset('home-assets/img/service-1.jpg') }}); height: 150px; width: 300px; background-size: cover; background-position: center;">
                                    </div>
                                @else
                                    <div
                            ...
                            <div class="service-text">
                                <p class="text-white mb-0" style="font-size: 0.85rem;">{!! str()->limit($nws->content, 170, ' ...') !!}</p>
                            </div>
                        </div>
