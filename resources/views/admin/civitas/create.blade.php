        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="{{ url('dashboard/civitas/store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card mt-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nidn') is-invalid @enderror"
                                                value="{{ old('nidn') }}" id="nidn" name="nidn" maxlength="9"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('jabatan') }}" id="jabatan" name="jabatan" required
                                                maxlength="18">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('pendidikan') }}" id="pendidikan" name="pendidikan"
                                                required>
                                        </div>
                                    </div>
                                </div>
