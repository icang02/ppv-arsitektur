                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($sliders as $slider)
                                        <tr>
                                            ...
                                            <td>
                                                <span>
                                                    <button class="btn-sm btn-warning" data-toggle="modal"
                                                        data-target="#modalUpdate{{ $slider->id }}">
                                                        <i class="fas fa-edit"></i></button>
                                                </span>
                                                <form class="d-inline"
                                                    action="{{ url('dashboard/sliders/delete/' . $slider->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <span>
                                            ...
                                            <td>
                                                <div class="filtr-item col-sm-2" data-sort="white sample">
                                                    <a href="{{ asset("storage/$slider->image") }}" data-toggle="lightbox"
                                                        data-title="Slider">
                                        ...
                                        {{-- modal update data --}}
                                        <div class="modal fade" id="modalUpdate{{ $slider->id }}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body justify-content-end">
                                                        ...
                                                        <form action="{{ url("/dashboard/sliders/update/$slider->id") }}"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body justify-content-end">
                                        ...
                                        <form action="{{ url('/dashboard/sliders/store') }}" method="post"
